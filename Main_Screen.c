...
{ 
    ...
    strcpy(txt,"ECE3301L FinSP24/2/01\0");         // Text displayed 
...
void Update_Screen(void)
{
    ...
    DC_Txt[1] = (duty_cycle / 10) % 10  + '0'; // add code 
    DC_Txt[2] = duty_cycle % 10  + '0'; // add code      
    ...
    RPM_Txt[1] = (rpm/100) % 10  + '0'; // add code  
    RPM_Txt[2] = (rpm/10) % 10  + '0'; // add code  
