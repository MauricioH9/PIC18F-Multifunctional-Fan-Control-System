...
void Update_Setup_Time_Screen(void)
{
    ...
    setup_time[3]  = (setup_minute / 10) + '0';  // Minute ten
    setup_time[4]  = (setup_minute % 10) + '0';  // Minute one
  

    setup_time[6]  = (setup_second / 10) + '0';  // Second ten
    setup_time[7]  = (setup_second % 10) + '0';  // Second one
    

    setup_date[0]  = (setup_month / 10) + '0';   // Month ten
    setup_date[1]  = (setup_month % 10) + '0';   // Month one
 
    setup_date[3]  = (setup_day / 10) + '0';     // Day ten
    setup_date[4]  = (setup_day % 10) + '0';     // Day one


    setup_date[6]  = (setup_year / 10) + '0';    // Year ten
    setup_date[7]  = (setup_year % 10) + '0';    // Year one
