...
void Update_Setup_Alarm_Time_Screen(void)
{
    ...
    setup_alarm_time[1]  = (setup_alarm_hour%10)  + '0';							// add code here for hour one
    setup_alarm_time[3]  = (setup_alarm_minute/10)  + '0';							// add code here for min ten
    setup_alarm_time[4]  = (setup_alarm_minute%10)  + '0';							// add code here for min one 
    setup_alarm_time[6]  = (setup_alarm_second/10)  + '0';							// add code here for year ten 
    setup_alarm_time[7]  = (setup_alarm_second%10)  + '0';							// add code here for year one 				
