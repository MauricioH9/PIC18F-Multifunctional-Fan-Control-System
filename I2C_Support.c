...
void DS3231_Setup_Time()
{
    char Device = 0x68;                                         // Device ID
    char Address = 0x00;                                        // Beginning Address 0
    second = 0x00;                                              // Set seconds to :06
    minute = 0x00;                                              // Set minutes to :28
    hour = 0x16;                                                // Set hours to 0700
    dow = 0x02;                                                 // Set to... Monday?
    day = 0x07;                                                 // Set to the 24th
    month = 0x05;                                               // Set to July
    year = 0x24;                                                // Set to '52
    I2C_Start();                                                // Start I2C protocol
